...
class LokasiController extends Controller
{
    ...
    public function show(Lokasi $lokasi)
    {
        ...
        // buat Hitung panjang isian dari progresbar ny
        $percentage =
            $totalPohonDitanam > 0
            ? ($totalPohonHidup / $totalPohonDitanam) * 100
            : 0;

        $user = Auth::user(); // Mengembalikan pengguna yang sedang login.
        ...
        return view('Web.Lokasi-Penanaman.show', $data, compact('percentage', 'user'));
    }
}
