					...
					<ul class="lab-ul">
						...
						<li class="active">
							...
							<ul class="lab-ul">
								...
								<li class="active"><a href="faq-page.html">Faq Page</a></li>
							...
							<div class="main-menu d-flex flex-wrap align-items-center justify-content-between w-100">
								...
								<ul class="lab-ul">
									...
									<li>
										...
										<ul class="lab-ul">
											<li><a href="team.html">Team Membar</a></li>
											<li><a href="faq-page.html" class="active">Faq Page</a></li>
											<li><a href="404.html">404 Page</a></li>
										</ul>
									</li>
									<li>
	...
	<section class="page-header bg_img padding-tb">
		...
		<div class="container">
			<div class="page-header-content-area">
				<h4 class="ph-title">Poultry Farm Faq</h4>
				<ul class="lab-ul">
				...
				<div class="col-lg-4 col-12">
					<div class="faq-tab">
						...
						<ul class="agri-ul nav" id="myTab" role="tablist">
							<li class="nav-item">
								<a class="active" id="purchas-tab" data-toggle="tab" href="#purchas" role="tab"
									aria-controls="purchas" aria-selected="true">Customer Support</a>
							</li>
							<li class="nav-item">
							...
							<li class="nav-item">
								<a id="price-tab" data-toggle="tab" href="#price" role="tab" aria-controls="price"
									aria-selected="false">Pricing & Support</a>
							</li>
							<li class="nav-item">
								<a id="care-tab" data-toggle="tab" href="#care" role="tab" aria-controls="care"
									aria-selected="false">Purchasing Online</a>
							</li>
							<li class="nav-item">
								<a id="return-tab" data-toggle="tab" href="#return" role="tab" aria-controls="return"
									aria-selected="false">Returns</a>
							</li>
							<li class="nav-item">
								<a id="Technical-tab" data-toggle="tab" href="#Technical" role="tab"
							...
							<div id="accordion">
								<div class="card">
									<div class="card-header" id="headingOne">
										<button class="faq-item" data-toggle="collapse" data-target="#collapseOne"
									...
									<div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
										...
										<div class="card-body">
											<p>Fusce dignissim, diam quis faucibus posuere, metus ipsum dictum Edite
												dapibus quam lectus nec magna. Nunc fermentum felis eu pulvinar over
												nulla sodales nisi est, a rutrum urna egestas vitae. </p>
										</div>
									</div>
								</div>
								<div class="card">
									<div class="card-header" id="headingTwo">
										<h5 class="mb-0">
											<button class="faq-item collapsed" data-toggle="collapse"
									...
									<div id="collapseTwo" class="collapse" aria-labelledby="headingTwo"
										data-parent="#accordion">
										<div class="card-body">
											<p>Why I say old chap that is spiffing pukka, bamboozled wind up bugger
												...
												BBC. Tickety-boo Elizabeth plastered matie.!</p>
										</div>
									</div>
								</div>
								<div class="card">
								...
								<div class="card">
									...
									<div id="collapsefour" class="collapse" aria-labelledby="headingfour"
										...
										<div class="card-body">
											...
											buggered zonked hanky panky a blinding shot the little rotter, bubble and
											squeak vagabond cheeky bugger at public school pardon you bloke the BBC.
							...
							<div id="accordion3">
								<div class="card">
									<div class="card-header" id="heading10">
										<button class="faq-item" data-toggle="collapse" data-target="#collapse10"
							...
							<div id="accordion4">
								<div class="card">
									<div class="card-header" id="heading15">
										<button class="faq-item" data-toggle="collapse" data-target="#collapse15"
							...
							<div id="accordion6">
								<div class="card">
									<div class="card-header" id="heading24">
										<button class="faq-item" data-toggle="collapse" data-target="#collapse24"
							...
							<div id="accordion2">
								<div class="card">
									<div class="card-header" id="headingsix">
										<button class="faq-item" data-toggle="collapse" data-target="#collapsesix"
							...
							<div id="accordion5">
								<div class="card">
									<div class="card-header" id="heading20">
										<button class="faq-item" data-toggle="collapse" data-target="#collapse20"
