        ...
        <div class="row align-items-end">
            <div class="col-lg-8">
                <div class="page-header-title">
                    ...
                    <div class="d-inline">
                        <h5>Dashboard</h5>
                        <span>Halaman Dashboard, Dek Dek Tutor Dek.....</span>
                    </div>
                </div>
            </div>
            <div class="col-lg-4">
                                            ...
                                            <div class="row p-t-20 p-b-30">
                                                ...
                                                <div class="col p-l-5">
                                                    ...
                                                    <p class="text-muted m-b-0">Lorem ipsum dolor
                                                        sit amet, <a href="#!" class="text-c-blue"> More</a></p>
                                                </div>
                                            </div>
                                            <div class="row p-b-30">
                                                <div class="col-auto text-right update-meta p-r-0">
                                                ...
                                                <div class="col p-l-5">
                                                    ...
                                                    <p class="text-muted m-b-0">Lorem dolor sit
                                                        amet, <a href="#!" class="text-c-blue"> More</a></p>
                                                </div>
                                            </div>
                                            <div class="row p-b-30">
                                                <div class="col-auto text-right update-meta p-r-0">
                                                ...
                                                <div class="col p-l-5">
                                                    ...
                                                    <p class="text-muted m-b-0">Lorem ipsum dolor
                                                        sit ipsum amet, <a href="#!" class="text-c-green">
                                                            More</a></p>
                                                </div>
                                            </div>
                                            <div class="row p-b-30">
                                                ...
                                                <div class="col p-l-5">
                                                    ...
                                                    <p class="text-muted m-b-0">Lorem ipsum dolor
                                                        sit amet, <a href="#!" class="text-c-red"> More</a></p>
                                                </div>
                                            </div>
                                            <div class="row p-b-30">
                                                <div class="col-auto text-right update-meta p-r-0">
                                        ...
                                        <table class="table table-hover m-b-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>Sofa</td>
                                                    <td>#PHD001</td>
                                                    <td><a href="assets/cdn-cgi/l/email-protection"
                                                            class="__cf_email__"
                                                            data-cfemail="f1909392b1969c90989ddf929e9c">[email&#160;protected]</a>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="assets/cdn-cgi/l/email-protection"
                                                            class="__cf_email__"
                                                            data-cfemail="f4848586b49399959d98da979b99">[email&#160;protected]</a>
                                                    </td>
                                                    <td><label class="label label-danger">Out
                                                            Stock</label></td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="assets/cdn-cgi/l/email-protection"
                                                            class="__cf_email__"
                                                            data-cfemail="1674756556717b777f7a3875797b">[email&#160;protected]</a>
                                                    </td>
                                                    <td><label class="label label-success">In
                                                            Stock</label></td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="assets/cdn-cgi/l/email-protection"
                                                            class="__cf_email__"
                                                            data-cfemail="0c6f686f4c6b616d6560226f6361">[email&#160;protected]</a>
                                                    </td>
                                                    <td><label class="label label-success">In
                                                            Stock</label></td>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="assets/cdn-cgi/l/email-protection"
                                                            class="__cf_email__"
                                                            data-cfemail="5626272416313b373f3a7835393b">[email&#160;protected]</a>
                                                    </td>
                                                    <td><label class="label label-danger">Out
                                                            Stock</label></td>
                                                    <td>
