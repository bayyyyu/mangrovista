<div id="belumSelesai" class="tabcontent" style="display: none;">
    <div class="shop-product-wrap grids row ">
        @if ($list_event_belum_selesai->isEmpty())
            <div class="col-md-12" style="display: flex; justify-content: center; align-items: center; height: 60vh;">
                <div style="display: flex; flex-direction: column; align-items: center; justify-content: center;">
                    ...
                    <span class="text-dark">Tidak Ada Data Event Belum Selesai.</span>
                        ...
                        <div class="card-body p-0">
                            <a href="{{ url('Event', $event->id) }}">
                                ...
                                <div class="p-4 " style="height: 65px">
                                    <h3 style="font-size: 15px; color:#090909;" class="fw-semibold mb-0 fs-4">
                                        @php
                                            $maxLength = 55;
