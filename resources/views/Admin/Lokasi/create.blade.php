    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12 mt-3">
                <a href="{{ url('Admin/Lokasi') }}" class="btn btn-primary btn-sm mb-1"> <i class="fa fa-arrow-left ">
                    </i>
                    Kembali</a>
                <div class="card">
                    <div class="card-header bg-primary">
                        <p style="color:white"> Tambah Data Lokasi </p>
                    </div>
                    <div class="card-body">
                        <form action="{{ url('Admin/Lokasi') }}" enctype="multipart/form-data" method="POST">
                            @csrf
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="message-text" class="col-form-label">Alamat Lokasi:<span
                                                    style="color: red">*</span></label>
                                            <textarea class="form-control" id="message-text" name="alamat_lokasi">{{ old('alamat_lokasi') }}</textarea>
                                            @error('alamat_lokasi')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                        </div>
